...
RSpec.describe Meeting, type: :model do
  context "validation tests" do
    ...
    it 'ensures date presence' do
      meeting = Meeting.new(date:"18/10/2020", start_time: "18:00", duration_minutes: 30, title: "Test meeting").save
    ...
    it 'ensures two meetings cant be scheduled at the same room at the same duration' do
      meeting1 = Meeting.create(room_id: 2, user_id: 3, duration_minutes: 30, date: "10/12/2020", start_time:"19:00")
